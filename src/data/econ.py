...
E1_meanings = {
    ...
    "1/0" : 'Government is replacing less than 50%% of lost salary, formal sector workers only',
    "2/0" : 'Government is replacing 50%% or more of lost salary, formal sector workers only',
    "1/1" : 'Government is replacing less than 50%% of lost salary, all workers',
    "2/1" : 'Government is replacing 50%% or more of lost salary, all workers',
}
E2_meanings = {
