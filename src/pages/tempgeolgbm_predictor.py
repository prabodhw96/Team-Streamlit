...
MODEL_FILE = 'src/models/model.pkl'
...
class tempGeoLGBMPredictor(BasePredictor):
    ...
    """
    def __init__(self, nb_lookback_days=NB_LOOKBACK_DAYS, nb_test_days=NB_TEST_DAYS, window_size=WINDOW_SIZE, npi_delay=NPI_DELAY, seed=base.SEED):
    ...
    def _get_new_cases_preds(self, c_df, g, npis_df, temp_df):
        ...
        preds = self._roll_out_predictions(self.predictor, initial_context_input, initial_action_input, npis_sequence, temp_sequence, holiday_sequence)
        preds_cases = preds[:,0]
