...
def write():
	...
	st.write("SARS-COV-2 is a highly infectious pathogen capable of causing a disease called Covid-19 which usually presents as inflammation in the lungs.  The virus itself is not extremely virulent which allows it to spread to many people and cause a pandemic.  Furthermore, the virus seems to disproportionately cause disease in the elderly where an [exponential distribution](upload://https://www.medrxiv.org/content/10.1101/2020.08.25.20181487v1.full-text) is observed when plotting the probability of death vs age of patients who have Covid-19 and been hospitalized.  The cause for this age-susceptibility relationship is currently a matter of scientific debate however the same pattern can be observed when plotting the output of the thymus gland over time and comparing the charts from men and women.  Many hypotheses have been advanced including one due to entropy, another due to the reduction of the production of regulatory T-cells that suppress auto-immune reactions and other genetic factors such as changes in the expression of Angiotensin Convertin Enzyme-2 receptor availability on the cell membrane.  The threat to humanity of a similar virus had been established in [2015](upload://https://www.nature.com/articles/nm.3985) where a partnership between the Wuhan institute of virology and an American university investigated the potential for a SARS-like coronavirus to develop affinity to the human ACE2 receptor.")
	st.write("In 2017, a company with an organic synthesis for a safe biological response modifier capable of accelerating the maturation and production of T-cells from the thymus, already shown to be effective against SARS-COV-1 was delisted from the NASDAQ and [privatized by a Chinese consortium](upload://https://www.genengnews.com/topics/drug-discovery/chinese-investor-consortium-buys-sciclone-for-605m/) .  The Chinese government acted quickly to contain the spread of the virus and built [two hospitals in record time](upload:\\https://www.cnbc.com/2020/01/31/pictures-china-builds-two-hospitals-in-days-to-combat-coronavirus.html#:~:text=The%20Chinese%20city%20of%20Wuhan,which%20will%20provide%202%2C600%20beds.) and a large cohort of medical staff were sent to Hubei, the province at the center of the outbreak.  The [medical staff were administered this medication](upload://https://academic.oup.com/cid/article/71/16/2150/5842185), known as thymosin-alpha-1, seemingly ignored by Western medicine and the successes of this prophylactic immune-boosting campaign were reported in the medical literature.  Retrospective studies showed efficacy in reducing mortality, reversing exhausted T-cells and shortening the duration of the disease.  The first North American manuscript, published in June, recommended that thymosin be evaluated and there is now a [clinical trial in Rhode Island](upload://https://clinicaltrials.gov/ct2/show/NCT04487444) being conducted by a former Harvard medical professor.  The benefit of this approach is that it does not depend on a specific sequence of the virus and instead its effects are pleiotropic and include increasing the diversity of available T-cells thereby theoretically facilitating the recognition of virally infected cells in a manner somewhat resistant to mutations")
	st.write("In fact, this approach has recently been tried and found to be successful against [certain cancers] (upload://https://www.frontiersin.org/articles/10.3389/fonc.2019.00873/full) that display abberrant proteins on their cell surface much like a virally infected cell would.")
	st.write("In addition to this effort, there is a widescale attempt to vaccinate the public against a rapidly mutating and highly transmissible agent that is losing steam due to the new strains such as the one in South Africa which [halted the Astrazeneca vaccination in that country](upload://https://www.orilliamatters.com/world-news/in-switch-south-africa-to-give-health-workers-jj-vaccine-3369195).  As a result, a part of our contribution to this contest is to highlight the potential use of this agent and to encourage others to follow the clinical trial in Rhode Island closely because it may be a light at the end of the tunnel of a very difficult time in human history.")
	st.write("In addition to causing a terrible burden on the healthcare systems, there have been widespread economic repercussions disproportionately affecting low income and client-facing employees whose jobs depend on a healthy service industry.  The problems do not stop there since the closure of schools have resulted in a disproportionate effect on women's careers as they have been shown to be more likely to have chosen to take care of the children at home.  It is clear that a solution that is capable of addressing the problem of not only this particular virus but all future pandemics is needed so that our society is resilient to future outbreaks similar to the ones that happened in [1917-1918](https://www.cdc.gov/flu/pandemic-resources/1918-commemoration/1918-pandemic-history.htm) and [1928](https://ajph.aphapublications.org/doi/pdf/10.2105/AJPH.20.2.119) and that will most likely happen in the future.")
