...
DATA_FILE_PATH = "src/data/OxCGRT_latest.csv"
ADDITIONAL_CONTEXT_FILE = "src/data/Additional_Context_Data_Global.csv"
ADDITIONAL_US_STATES_CONTEXT = "src/data/US_states_populations.csv"
ADDITIONAL_UK_CONTEXT = "src/data/uk_populations.csv"
ADDITIONAL_BRAZIL_CONTEXT = "src/data/brazil_populations.csv"
